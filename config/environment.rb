...
Rails::Initializer.run do |config|
  ...
  expected_env = ENV['RAILS_ENV'] || 'development' || 'constraint' || 'postgres'
  unless ['development','cucumber','test', 'constraint', 'postgres'].include? expected_env #Rails.env.development?
    require 'psd_logger'
